...
class XoopsFormDhtmlTextArea extends XoopsFormTextArea
{
    ...
    function render()
    {
        ...
        if (empty($this->skipPreview)) {
            ...
            $button = // "<br />" .
"<input " . " id='" . $this->getName() . "_preview_button'" . "  class='btn btn-warning' type='button' " . " value='" . _PREVIEW . "' " . " onclick=\"form_instantPreview('" . XOOPS_URL . "', '" . $this->getName() . "','" . XOOPS_URL . "/images', " . intval($this->doHtml) . ", '" . $GLOBALS['xoopsSecurity']->createToken() . "')\"" . " />";
