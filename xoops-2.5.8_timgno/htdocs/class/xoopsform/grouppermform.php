 ...
 * @subpackage      form
 * @since           2.0.0
 * @version         $Id: grouppermform.php 12537 2014-05-19 14:19:33Z beckmi $
 */
    ...
    function render()
    {
        ...
        foreach(array_keys($elements) as $i) {
            if (! is_object($elements[$i])) {
                ...
                $ret .= '<tr valign="top" class="left"><td class="head">' . $elements[$i]->getCaption();
...
class XoopsGroupFormCheckBox extends XoopsFormElement
{
    ...
    function render()
    {
        ...
        $ret = '<table class="table table-bordered"><tr><td class="odd"><table class="table table-striped"><tr>';
        $cols = 1;
