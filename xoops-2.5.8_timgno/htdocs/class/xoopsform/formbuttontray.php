 ...
 * @version         $Id: formbuttontray.php 12537 2014-05-19 14:19:33Z beckmi $
 *
 */
...
class XoopsFormButtonTray extends XoopsFormElement
{
    ...
    function render()
    {
        ...
        $ret .= '<input type="button" value="' . _CANCEL . '" onClick="history.go(-1);return true;" />&nbsp;<input type="reset" class="btn btn-primary"  name="reset"  id="reset" value="' . _RESET . '" />&nbsp;<input type="' . $this->getType() . '" class="btn btn-default"  name="' . $this->getName() . '"  id="' . $this->getName() . '" value="' . $this->getValue() . '"' . $this->getExtra() . '  />';
