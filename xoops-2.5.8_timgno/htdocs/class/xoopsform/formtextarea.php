 ...
 * @version         $Id: formtextarea.php 12537 2014-05-19 14:19:33Z beckmi $
 */
...
class XoopsFormTextArea extends XoopsFormElement
{
    ...
    function render()
    {
        return "<textarea name='" . $this->getName() . "' id='" . $this->getName() . "' class=\"form-control\" title='" . $this->getTitle() . "' rows='" . $this->getRows() . "' cols='" . $this->getCols() . "'" . $this->getExtra() . ">" . $this->getValue() . "</textarea>";
    }
}
