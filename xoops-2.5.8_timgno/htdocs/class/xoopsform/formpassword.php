 ...
 * @version         $Id: formpassword.php 12537 2014-05-19 14:19:33Z beckmi $
 */
...
class XoopsFormPassword extends XoopsFormElement
{
    ...
    function render()
    {
        return '<input type="password" name="' . $this->getName() . '" id="' . $this->getName() . '" class="form-control" size="' . $this->getSize() . '" maxlength="' . $this->getMaxlength() . '" value="' . $this->getValue() . '"' . $this->getExtra() . ' ' . ($this->autoComplete ? '' : 'autocomplete="off" ') . '/>';
    }
}
