...
echo "
<form class=\"form-inline\" name='ConfigForm' action='' method='POST'>
	...
	<table class=\"table table-bordered\">
		<tbody>
			...
			<tr valign='top' align='left'>
				...
				<td class='even'>
				  <input type='submit' class=\"btn btn-default\" value='"._GO."' />
				</td>
			</tr>
		</tbody>
	</table>
...
<form class=\"form-inline\" action='' method='GET' style='margin-bottom:0px;'>
  <table class=\"table table-bordered\">
    <tr>
      <td align='left'>
        <select name='num' onchange='submit();'>$num_options</select>
        <input type='submit' class=\"btn btn-default\" value='"._SUBMIT."'>
      </td>
      <td align='right'>
        $nav_html
      </td>
...
echo "
  <tr>
    <td colspan='8' align='left'>"._AM_LABEL_REMOVE." <input type='button' class=\"btn btn-default\" value='"._AM_BUTTON_REMOVE."' onclick='if (confirm(\""._AM_JS_REMOVECONFIRM."\")) {document.MainForm.action.value=\"delete\"; submit();}' /></td>
  </tr>
</table>
<div align='right'>
  $nav_html
...
<div align='right'>
"._AM_LABEL_COMPACTLOG."<input type='button' class=\"btn btn-default\" value='"._AM_BUTTON_COMPACTLOG."' onclick='if (confirm(\""._AM_JS_COMPACTLOGCONFIRM."\")) {document.MainForm.action.value=\"compactlog\"; submit();}' />
&nbsp;
"._AM_LABEL_REMOVEALL."<input type='button' class=\"btn btn-default\" value='"._AM_BUTTON_REMOVEALL."' onclick='if (confirm(\""._AM_JS_REMOVEALLCONFIRM."\")) {document.MainForm.action.value=\"deleteall\"; submit();}' />
</div>
</form>
</td></tr></table>
" ;
