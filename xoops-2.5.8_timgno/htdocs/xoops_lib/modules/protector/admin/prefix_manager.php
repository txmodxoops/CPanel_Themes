...
foreach ($prefixes as $prefix) {
    ...
    if ($prefix['name'] == XOOPS_DB_PREFIX) {
        ...
        $del_button = "<input type='submit' class=\"btn btn-default\" name='delete' value='delete' onclick='return confirm(\""._AM_CONFIRM_DELETE."\")' />" ;
        $style_append = '' ;
    }
    ...
    <tr>
        ...
        <td class='odd' style='text-align:center;$style_append;' nowrap='nowrap'>
            <form action='?page=prefix_manager' method='POST' style='margin:0;'>
                ...
                <input type='submit' class=\"btn btn-default\" name='copy' value='copy' />
            </form>
        </td>
        <td class='odd' style='text-align:center;$style_append;'>
            <form action='?page=prefix_manager' method='POST' style='margin:0;'>
                ...
                $del_button
                <input type='submit' class=\"btn btn-default\" name='backup' value='backup' onclick='this.form.target=\"_blank\"' />
            </form>
        </td>
    </tr>\n" ;
