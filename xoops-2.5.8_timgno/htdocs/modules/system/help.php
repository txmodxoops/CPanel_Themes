 ...
 * @version     $Id: help.php 12795 2014-09-21 05:41:46Z beckmi $
 */
...
if ($mid > 0) {
    ...
    if ($page != '') {
        // Call template
        if (file_exists(
            XOOPS_ROOT_PATH . '/modules/' . $module->getVar('dirname', 'e') . '/language/' . $xoopsConfig['language'] . '/help/' . $page . '.tpl'
        )
        ) {
            ...
            if (file_exists(
                XOOPS_ROOT_PATH . '/modules/' . $module->getVar('dirname', 'e') . '/language/english/help/' . $page . '.tpl'
            )
            ) {
                $helpcontent = $xoopsTpl->fetch(
                    XOOPS_ROOT_PATH . '/modules/' . $module->getVar('dirname', 'e') . '/language/english/help/' . $page . '.tpl'
        ...
        if (file_exists(
            XOOPS_ROOT_PATH . '/modules/' . $module->getVar('dirname', 'e') . '/language/' . $xoopsConfig['language'] . '/help/module_index.tpl'
        )
        ) {
            $helpcontent = $xoopsTpl->fetch(
                XOOPS_ROOT_PATH . '/modules/' . $module->getVar('dirname', 'e') . '/language/'
                . $xoopsConfig['language'] . '/help/module_index.tpl'
            );
        } else {
    ...
    if (file_exists(
        XOOPS_ROOT_PATH . '/modules/system/language/' . $xoopsConfig['language'] . '/help/help_center.tpl'
    )
    ) {
        $helpcontent = $xoopsTpl->fetch(
            XOOPS_ROOT_PATH . '/modules/system/language/' . $xoopsConfig['language'] . '/help/help_center.tpl'
