        ...
        $form->addElement(new XoopsFormButton('', 'button', _GO, 'submit'));
           if ($module->getVar('name') == 'System'){
               ...
               if ($module->getInfo('adminindex')) {
                   echo '<li><a href="' . XOOPS_URL . '/modules/' . $module->getVar('dirname') . '/' . $module->getInfo('adminindex') .'">' . $module->getVar('name') . '</a>&nbsp;<span style="font-weight:bold;">&nbsp;&raquo;&nbsp;</span>&nbsp;' . _PREFERENCES . '</li>';
               } else {
                   echo $module->getVar('name') . '<li><span style="font-weight:bold;">&nbsp;&raquo;&nbsp;</span>&nbsp;' . _PREFERENCES . '<li>';
               }
			   echo '</ol>';
           }
        $form->display();
