 ...
 * @package     system
 * @version     $Id: jquery.php 12104 2013-09-28 21:37:53Z beckmi $
 */
...
switch ($op) {
    ...
    case 'tpls_edit_file':
        ...
        if (file_exists($path_file.'.back')) {
            $restore = '<button class="btn btn-default" type="button" onclick="tpls_restore(\''.$path_file.'\')" value="'._AM_SYSTEM_TEMPLATES_RESTORE.'" title="'._AM_SYSTEM_TEMPLATES_RESTORE.'">
                    ...
                    <td>
                          <div class="xo-btn-actions">
                              <div class="xo-buttons">
                                  <button class="btn btn-default" type="submit" value="'._AM_SYSTEM_TEMPLATES_SAVE.'" title="'._AM_SYSTEM_TEMPLATES_SAVE.'">
                                      <img src="'.system_AdminIcons('save.png').'" alt="'._AM_SYSTEM_TEMPLATES_SAVE.'" />
                                  </button>
                                  '.$restore.'
                                  <button class="btn btn-default" type="button" onclick="$(\'#display_contenu\').hide();$(\'#display_form\').fadeIn(\'fast\');" title="'._AM_SYSTEM_TEMPLATES_CANCEL.'">
