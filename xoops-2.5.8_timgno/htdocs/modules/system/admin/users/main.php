...
switch ($op) {
    ...
    default:
        ...
        if (isset($_REQUEST['complet_search'])) {
            ...
            //Form tris
            $form = '<form class="form-inline" action="admin.php?fct=users" method="post">
                    '._AM_SYSTEM_USERS_SEARCH_USER.'<input type="text" name="user_uname" class="form-control" value="'.$myts->htmlSpecialChars($user_uname).'" size="15">
            ...
            $form .= '</select>&nbsp;
                ...
                <input type="hidden" name="user_uname_match" class="form-control" value="XOOPS_MATCH_START" />
                <input type="submit" name="speed_search" class="btn btn-default" value="'._AM_SYSTEM_USERS_SEARCH.'" />&nbsp;
                <input type="submit" name="complet_search" class="btn btn-default" value="'._AM_SYSTEM_USERS_ADVANCED_SEARCH.'" /></form>
                ';

            //select groupe
            $form_select_groups = '<select class="form-control" name="selgroups" id="selgroups" style="display:none;"><option value="">---------</option>';
