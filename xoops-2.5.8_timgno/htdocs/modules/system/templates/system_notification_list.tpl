...
<table class="table table-bordered">
	...
	<tr>
		<td class="foot" colspan="5">
			<input type="submit" class="btn btn-default" name="delete_cancel" value="<{$lang_cancel}>" />
			<input type="reset" class="btn btn-default" name="delete_reset" value="<{$lang_clear}>" />
			<input type="submit" class="btn btn-default" name="delete" value="<{$lang_delete}>" />
