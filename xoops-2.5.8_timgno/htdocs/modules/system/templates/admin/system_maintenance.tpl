...
<br />
<{if $form_maintenance}>
    <div class="form-inline"><{$form_maintenance}></div><br />
	<div class="form-inline"><{$form_dump}></div>
<{elseif $maintenance}>
	<{if $verif_cache || $verif_session || $verif_avatar}>
		<table class="table table-bordered">
			...
			<{if $verif_cache}>
				<tr>
					<td class="aligntop text-center"><{$smarty.const._AM_SYSTEM_MAINTENANCE_RESULT_CACHE}></td>
					<td class="aligntop text-center"><{if $result_cache}><img width="16" src="<{xoAdminIcons success.png}>" /><{else}><img style="width:16px;" src="<{xoAdminIcons cancel.png}>" alt="Cancel"/><{/if}></td>
				</tr>
			<{/if}>
