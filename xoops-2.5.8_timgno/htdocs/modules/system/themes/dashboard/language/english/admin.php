...
//Add User
define('_CPANEL_WELCOME',"Welcome");
define('_CPANEL_PROFILE',"Profile");
define('_CPANEL_MESSAGES',"Messages");
define('_CPANEL_ALBUMS',"Albums");
define('_CPANEL_TASKS',"Tasks");
define('_CPANEL_SETTINGS',"Settings");
//Add help
