 ...
 * @version     1.2
 * @version     $Id: newage.php 12852 2014-12-27 09:14:37Z timgno $
 */

/**
 * Class XoopsGuiNewage
 */
class XoopsGuiNewage extends XoopsSystemGui
{
    ...
    function header()
    {
        ...
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/newage/assets/js/styleswitch.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/newage/assets/js/formenu.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/newage/assets/js/menu.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/newage/assets/js/tooltip.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/newage/assets/js/tabs.jquery.tools.min.js');

        /*$xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/newage/assets/css/style.css' );
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/newage/assets/css/dark.css', array('title' => 'dark', 'media' => 'screen'));
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/newage/assets/css/silver.css', array('title' => 'silver', 'media' => 'screen'));
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/newage/assets/css/orange.css', array('title' => 'orange', 'media' => 'screen'));*/
        ...
        $menu[1]['absolute'] = 1;
        $menu[1]['icon'] = XOOPS_ADMINTHEME_URL . '/newage/assets/img/xoops.png';
        $menu[2]['link'] = XOOPS_URL . '/user.php?op=logout';
        $menu[2]['title'] = _LOGOUT;
        $menu[2]['absolute'] = 1;
        $menu[2]['icon'] = XOOPS_ADMINTHEME_URL . '/newage/assets/img/logout.png';
        ...
        if (empty($xoopsModule) || 'system' == $xoopsModule->getVar('dirname', 'n')) {
            ...
            foreach (array_keys($mod_options) as $item) {
                ...
                $mod_options[$item]['icon'] = empty($mod_options[$item]['icon']) ? '' : XOOPS_ADMINTHEME_URL . '/newage/' . $mod_options[$item]['icon'];
        ...
        $OPT[] = array(
            ...
            'absolute'  => 1,
            'icon'     => XOOPS_ADMINTHEME_URL . '/newage/assets/icons/prefs_small.png');
        $OPT[] = array(
        ...
        $menu[] = array(
            ...
            'absolute'  => 1,
            'icon'     => XOOPS_ADMINTHEME_URL . '/newage/assets/img/xoops.png');
        $menu[] = array(
        ...
        $menu[] = array(
            ...
            'absolute'  => 1,
            'icon'     => XOOPS_ADMINTHEME_URL . '/newage/assets/img/tweb.png');
        ...
        if (file_exists($file = XOOPS_ADMINTHEME_PATH . '/newage/language/' . $xoopsConfig['language'] . '/localsupport.php' )) {
            $links = include XOOPS_ADMINTHEME_PATH . '/newage/language/' . $xoopsConfig['language'] . '/localsupport.php';
            if ( count($links) > 0 ) {
