 <div id="accordion">
    ...
    <div class="pane">
      <p id="xolicenses"><a rel="external" href="http://www.gnu.org/licenses/gpl-2.0.html" title="<{$smarty.const.XOOPS_LICENSE_TEXT}>"><{$smarty.const.XOOPS_LICENSE_TEXT}></a></p>
    </div>
    ...
    <div class="pane">
      <table>
         <tr>
             <td><a rel="external" href="http://sourceforge.net/projects/xoops"><{$smarty.const._OXYGEN_XOOPSPROJECT}></a></td>
