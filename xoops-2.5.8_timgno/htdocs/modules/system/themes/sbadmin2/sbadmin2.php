...
/*
 * Xoops Cpanel SbAdmin2 GUI class
 *
 ...
 * @version     1.2
 * @version     $Id: sbadmin2.php 12852 2014-12-27 09:14:37Z timgno $
 */

/**
 * Class XoopsGuisbadmin2
 */
class XoopsGuiSbAdmin2 extends XoopsSystemGui
{
    ...
    function header()
    {
        ...
        /*$xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/sbadmin2/assets/css/style.css' );
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/sbadmin2/assets/css/dark.css', array('title' => 'dark', 'media' => 'screen'));
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/sbadmin2/assets/css/silver.css', array('title' => 'silver', 'media' => 'screen'));
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/sbadmin2/assets/css/orange.css', array('title' => 'orange', 'media' => 'screen'));*/
        ...
        $menu[1]['absolute'] = 1;
        $menu[1]['icon'] = XOOPS_ADMINTHEME_URL . '/sbadmin2/assets/img/xoops.png';
        $menu[2]['link'] = XOOPS_URL . '/user.php?op=logout';
        $menu[2]['title'] = _LOGOUT;
        $menu[2]['absolute'] = 1;
        $menu[2]['icon'] = XOOPS_ADMINTHEME_URL . '/sbadmin2/assets/img/logout.png';
        ...
        if (empty($xoopsModule) || 'system' == $xoopsModule->getVar('dirname', 'n')) {
            ...
            foreach (array_keys($mod_options) as $item) {
                ...
                $mod_options[$item]['icon'] = empty($mod_options[$item]['icon']) ? '' : XOOPS_ADMINTHEME_URL . '/sbadmin2/' . $mod_options[$item]['icon'];
        ...
        $OPT[] = array(
            ...
            'absolute'  => 1,
            'icon'     => XOOPS_ADMINTHEME_URL . '/sbadmin2/assets/icons/prefs_small.png');
        $OPT[] = array(
        ...
        $menu[] = array(
            ...
            'absolute'  => 1,
            'icon'     => XOOPS_ADMINTHEME_URL . '/sbadmin2/assets/img/xoops.png');
        $menu[] = array(
        ...
        $menu[] = array(
            ...
            'absolute'  => 1,
            'icon'     => XOOPS_ADMINTHEME_URL . '/sbadmin2/assets/img/tweb.png');
        ...
        if (file_exists($file = XOOPS_ADMINTHEME_PATH . '/sbadmin2/language/' . $xoopsConfig['language'] . '/localsupport.php' )) {
            $links = include XOOPS_ADMINTHEME_PATH . '/sbadmin2/language/' . $xoopsConfig['language'] . '/localsupport.php';
            if ( count($links) > 0 ) {
	...
	function footer()
    {
        ...
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/sbadmin2/assets/js/bootstrap.min.js');
		$xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/sbadmin2/assets/js/styleswitch.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/sbadmin2/assets/js/formenu.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/sbadmin2/assets/js/menu.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/sbadmin2/assets/js/tooltip.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/sbadmin2/assets/js/tabs.jquery.tools.min.js');
	}
}