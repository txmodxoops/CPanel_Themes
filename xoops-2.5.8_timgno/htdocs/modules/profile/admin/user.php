 ...
 * @version         $Id: user.php 12363 2014-03-08 10:39:06Z beckmi $
 */
...
switch ($op) {
    ...
    case "list":
        ...
        $form = new XoopsThemeForm(_AM_PROFILE_EDITUSER, 'form', 'user.php');
        $form->addElement(new XoopsFormSelectUser(_AM_PROFILE_SELECTUSER, 'id') );
    ...
    case "delete":
        ...
        if ( in_array(XOOPS_GROUP_ADMIN, $groups)  ) {
            redirect_header('user.php', 3, _AM_PROFILE_CANNOTDELETEADMIN, false);
        }
        ...
        if ( isset($_REQUEST['ok']) && $_REQUEST['ok'] == 1 ) {
            ...
            xoops_confirm(array('ok' => 1, 'id' => $_REQUEST['id'], 'op' => 'delete'), $_SERVER['REQUEST_URI'], sprintf(_AM_PROFILE_RUSUREDEL, $obj->getVar('uname') . " (" . $obj->getVar('email') . ")") );
        }
        break;
}
